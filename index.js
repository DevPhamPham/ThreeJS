...
function init() {
  ...
  new THREE.GLTFLoader().load("./GLBs/player/Soldier.glb", function (gltf) {
  ...
  function Animals() {
    ...
    //   var url = "./GLBs/animals/dino.glb";
    //   gltfLoader.load(url, (gltf) => {
    //     var root = gltf.scene;
    //     scene.add(root);
    //     root.position.set(50, 33, 80);
    //     root.scale.set(200, 200, 200);
    //   });
    // }
    
    // //                    add .GLTFLoader         pto.glb
    // {
    //   var gltfLoader = new THREE.GLTFLoader();
    //   var url = "./GLBs/animals/pto.glb";
    //   gltfLoader.load(url, (gltf) => {
    //     var root = gltf.scene;
    //     scene.add(root);
    //     root.position.set(-200, 400, -400);
    //     root.scale.set(450, 450, 450);
    //   });
    // }
  ...
  //   }
    ...
    function planes() {
      //                    add .GLTFLoader         moon.glb
    //   {
    //     var gltfLoader = new THREE.GLTFLoader();
    //     var url = "./GLBs/planes/moon.glb";
    //     gltfLoader.load(url, (gltf) => {
    //       planes = gltf.scene;
    //       scene.add(planes);
    //       planes.position.set(500, 600, -500);
    //       planes.scale.set(500, 500, 500);
    //     });
    //   }
    //   //                    add .GLTFLoader         jupiter.glb
    //   {
    //     var gltfLoader = new THREE.GLTFLoader();
    //     var url = "./GLBs/planes/jupiter.glb";
    //     gltfLoader.load(url, (gltf) => {
    //       planes = gltf.scene;
    //       scene.add(planes);
    //       planes.position.set(-1000, 100, -1000);
    //       planes.scale.set(500, 500, 500);
    //     });
    //   }
    //   //                    add .GLTFLoader         saturn.glb
    //   {
    //     var gltfLoader = new THREE.GLTFLoader();
    //     var url = "./GLBs/planes/saturn.glb";
    //     gltfLoader.load(url, (gltf) => {
    //       planes = gltf.scene;
    //       scene.add(planes);
    //       planes.position.set(0, 300, -1000);
    //       planes.scale.set(500, 500, 500);
